# ==============================================================================
# DSML_SS22_Luethi-Velkova-Zimmermann.R - Code playground for semester assignment
# in the dsml course.
# ==============================================================================
...
tidy(temperature_and_pollution_model)
confint(temperature_and_pollution_model, level = 0.95)
glance(temperature_and_pollution_model)

coef(temperature_and_pollution_model)
#plot(temperature_and_pollution_model)

# ==============================================================================
# END DSML_SS22_Luethi-Velkova-Zimmermann.R
# ==============================================================================
